...
function App() {
  let textLogo = "React";
  let [test, setes] = useState({author:'123', book:'1'})
  let [authors, setAut] = useState([
    ...
    book:[
            ...
            'Повести покойного Ивана Петрович Белкина (1830)',
            'Медный всадник (1833)',
            'Пиковая дама (1834)',
...
function onDeleteBook(index){
  let copy = authors.slice(authors.splice(index, 1));
            ...
            <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
              <ul className="navbar-nav mb-2 mb-lg-0">
                <li className="nav-item me-1">
                  <a href="https://react.dev/learn" className="btn btn-info">
                ...
                <li className="nav-item">
                  <a href="https://getbootstrap.com/docs/5.3/getting-started/introduction/" className="btn btn-info" >
        ...
        <div className="row mt-4">
          {
            authors.map((el, index)=>
              < AutBook el={el} key={index} onDeleteBook={onDeleteBook}  />
          )}
